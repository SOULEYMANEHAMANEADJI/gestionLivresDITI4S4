                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="nb_pages"  value="{{ $book->nb_pages }}" min="15" max="500" class="form-control @error('nb_pages') is-invalid @enderror">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="file" name="cover_image" value="{{ $book->cover_image }}" class="form-control @error('cover_image') is-invalid @enderror">
                            @error('cover_image')
                                <span class="text-danger mt-2">{{ $message }}</span>
                            @enderror
                        </div>
